...
ActiveRecord::Schema[7.1].define(version: 2024_06_21_191854) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dive_spot_id"], name: "index_reservations_on_dive_spot_id"
    t.index ["diver_id", "dive_spot_id"], name: "index_reservations_on_diver_id_and_dive_spot_id", unique: true
    t.index ["diver_id"], name: "index_reservations_on_diver_id"
  end
  ...
  add_foreign_key "reservations", "dive_spots"
  add_foreign_key "reservations", "divers"
